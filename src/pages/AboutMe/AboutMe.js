    ...
    return (
      <Page className="AboutMe" title="About Me">
        ...
        <div className="AboutMe-content">
          ...
          <p>I am passionate about web technologies and I love to experient things on my free time, trying out new frameworks, methods, tools, libraries and even languages sometimes. I am <a href="https://github.com/adriantoine" target="_blank">active on Github</a> and trying to contribute as much as I can as well as to maintain my own repos.</p>

          <h2>What do I do?</h2>
          <p>I have worked on several different projects, you can find more info about my commercial experience on <a href="http://uk.linkedin.com/in/adriantoine/en" target="_blank">my LinkedIn profile</a> and about my personal projects and involvment in open source projects on <a href="https://github.com/adriantoine" target="_blank">my Github profile</a>.</p>
        ...
        <div className="AboutMe-content">
          ...
          <SkillTable>
            ...
            <SkillTableItem icon="flux">Flux (especially using <a href="http://rackt.github.io/redux/" target="_blank">Redux</a>)</SkillTableItem>
            ...
            <SkillTableItem icon="cssmodules"><a href="https://github.com/css-modules/css-modules" target="_blank">CSS Modules</a></SkillTableItem>
          ...
          <p>A good thing to know about me is that I am French {this.emoji('😋')} so I obviously like cheese and wine. Then I love travelling and <a href="http://photo.adriantoine.com/" target="_blank">taking photos</a>, I'm also a big fan of cinema and enjoy going out in London in general {this.emoji('😊')}.</p>
          <p>If you want to contact me for a job, I prefer that you <a href="http://uk.linkedin.com/in/adriantoine/en" target="_blank">send me a message on LinkedIn</a>, and for everything else, you can contact me <a href="mailto:adriantoine@gmail.com">on my personal email</a> or <a href="https://twitter.com/adriantoine" target="_blank">my Twitter profile</a>.</p>
