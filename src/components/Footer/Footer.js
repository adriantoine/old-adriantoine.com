  ...
  return (
    <footer className={cn('Footer', {'Footer--fixed': props.isHome})}>
      ...
      <div className="Footer-credits">
        ...
        <p>Background images are from <a href="https://unsplash.com/" target="_blank" rel="noopener noreferrer">Unsplash</a>, icons are from <a href="http://evil-icons.io/" target="_blank" rel="noopener noreferrer">Evil Icons</a>, fonts are from <a href="https://www.google.com/fonts" target="_blank" rel="noopener noreferrer">Google Web Fonts</a></p>
      </div>
    </footer>
  );
}
